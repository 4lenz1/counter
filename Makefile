...
# Project:  counter.pro
# Template: app
# Command: C:\Qt\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ -o Makefile counter.pro
#############################################################################
...
Makefile: counter.pro ../../Qt/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf ../../Qt/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ -o Makefile counter.pro
